...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg"><?php echo __('Log In Untuk Masuk Ke Sistem') ?></p>
...
<?php echo $this->fetch('content'); ?>
    ...
    if (Configure::read('Theme.login.show_register')) {
        ?>
        <a href="<?php echo $this->Url->build('/register'); ?>" class="text-center"><?php echo __('Belum Punya Akun, Daftar Disini') ?></a>
        <?php
    }
    ?>
